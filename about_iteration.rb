...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject takes the argument and sets that to the accumulator, then runs the block on each value in the array and passes the accumulator to the next block
    # then inject returns the accumulator
  end
